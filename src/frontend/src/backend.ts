...
export class Backend implements backendInterface {
    ...
    async saveMessages(arg0: Array<Message>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveMessages(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedDemoMessages(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedDemoMessages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
